package dambae200.dambae200.global.error.exception;
...
public enum ErrorCode {
    ...
    // Cigarette
    OFFICIAL_DUPLICATION(HttpStatus.BAD_REQUEST.value(), "CG01", "Officialname is Duplication"),

    // CigaretteOnList
    DUPLICATE_CIGARETTEONLIST(HttpStatus.BAD_REQUEST.value(), "COL1", "Duplicate CigaretteOnList Registered"),

    //Section
    DUPLICATE_SECTION(HttpStatus.BAD_REQUEST.value(), "SE01", "SectionName is Duplication")
    ;
